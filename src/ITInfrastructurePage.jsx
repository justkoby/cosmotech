          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <div>
                ...
                <p style={{ margin: 0, fontSize: '13px', color: '#64748b' }}>Skilled technicians, strict quality control & assurance.</p>
              </div>
            </div>
            <div style={{ display: 'flex', gap: '12px' }}>
        ...
        <section className="service-process-section">
          ...
          <div className="process-timeline-grid">
            ...
            <div className="timeline-step">
              ...
              <h3 className="step-title">Implementation & Quality Control</h3>
              <p className="step-desc">Professional setup by skilled field technicians with stringent quality control and assurance.</p>
            </div>
            <div className="timeline-step">
