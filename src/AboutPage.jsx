    ...
    <div className="about-page-container">
      ...
      <section className="about-leadership-section">
        <div className="about-container-inner">
          ...
          <div className="leadership-competencies-box">
            <h3 className="competencies-title">COSMOTECH is led by professionals with deep experience in:</h3>
            <div className="competencies-grid">
              ...
              <div className="comp-item">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                <span>Telecommunications Systems</span>
              </div>
              <div className="comp-item">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
              ...
              <div className="comp-item">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                <span>Smart Building Technologies</span>
              </div>
            </div>
          </div>
        </div>
